package net.theforeveriris.irislineconsole.applicationMain.theming;

import android.content.Context;
import android.preference.PreferenceManager;

import net.theforeveriris.irislineconsole.applicationMain.theming.eachTheme.IrisLineConsoleDarkTheme;
import net.theforeveriris.irislineconsole.applicationMain.theming.eachTheme.IrisLineConsoleDefaultTheme;
import net.theforeveriris.irislineconsole.applicationMain.theming.eachTheme.IrisLineConsoleLightTheme;
import net.theforeveriris.irislineconsole.applicationMain.theming.eachTheme.MarineTheme;
import net.theforeveriris.irislineconsole.applicationMain.theming.eachTheme.OldComputerTheme;
...
public class AppThemeDirectory {
    ...
    private static final AppTheme[] THEMES = {
            new IrisLineConsoleDefaultTheme(),
            new IrisLineConsoleLightTheme(),
            new IrisLineConsoleDarkTheme(),
            new MarineTheme(),
