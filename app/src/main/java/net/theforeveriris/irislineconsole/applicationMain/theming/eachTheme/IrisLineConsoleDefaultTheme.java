...
import net.theforeveriris.irislineconsole.applicationMain.BaseWindowActivity;

public class IrisLineConsoleDefaultTheme extends BaseTheme {
    ...
    public void apply(BaseWindowActivity activity) {
        ...
        if (this.isDarkMode(activity)) {
            activity.setTheme(activity.isHomeActivity() ? R.style.AppThemeIrisLineConsoleDarkHome : R.style.AppThemeIrisLineConsoleDark);
        } else {
            activity.setTheme(activity.isHomeActivity() ? R.style.AppThemeIrisLineConsoleHome : R.style.AppThemeIrisLineConsole);
        }
