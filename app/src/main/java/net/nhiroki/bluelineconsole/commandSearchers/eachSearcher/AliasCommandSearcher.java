...
import net.nhiroki.bluelineconsole.applicationMain.PreferencesAliasesActivity;
...
import net.nhiroki.bluelineconsole.dataStore.persistent.AliasEntry;
import net.nhiroki.bluelineconsole.dataStore.persistent.AliasPreferences;
